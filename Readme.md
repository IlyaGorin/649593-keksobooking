...
* Студент: [Илья Горин](https://up.htmlacademy.ru/javascript/16/user/649593).
...
Если у вас ещё нет аккаунта на [github.com](https://github.com/join), скорее зарегистрируй тесь.
...
[travis-image]: https://travis-ci.com/htmlacademy-javascript/649593-keksobooking.svg?branch=master
[travis-url]: https://travis-ci.com/htmlacademy-javascript/649593-keksobooking
